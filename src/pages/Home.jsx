...
export default function Home() {
  return (
    <div>
      <Navbar/>
      <section className=' px-[10%] md:px-[5%] max-sm:px-0 h-[100vh] flex items-center'>
        <div className='glassMorph bordergrad flex gap-[90px] flex-col p-7'>
        
            <div className='flex items-center max-sm:flex-col'>
                <h3 className='headingfont font-bold text-3xl flex-1 items-start w-full my-4'>Unleash<br/>Your Mental Marvels</h3>
                <p className='flex-1 max-md:text-sm max-sm:text-xs'>Embark on a path of self-discovery with Manasvikaar, where the journey begins within. Unlock your inner potential as you delve into therapy, receive expert guidance, engage in journaling, and set meaningful goals, all tailored to empower you as the catalyst for your own mental transformation.</p>
            </div>
            <div>
      ...
      <section className='px-[10%] md:px-[5%] max-sm:px-0 flex flex-col items-center justify-center'>
      <h3 className='headingfont font-bold text-3xl flex-1 items-start w-full my-4'>Welcome, to Manasvikar</h3>
      ...
      <span className='headingfont font-bold text-3xl flex-1 items-start w-full my-4 sticky top-0 ' >Here’s how<br/>we help</span>
      ...
      <section className='px-[10%] md:px-[5%] max-sm:px-0 h-[100vh] flex items-center justify-center'>
        <h3 className='headingfont font-bold text-3xl'>“You didn’t come this far, only to come this far”</h3>
      </section>

      <section className='px-[10%] md:px-[5%] max-sm:px-0 flex flex-col justify-center'>
