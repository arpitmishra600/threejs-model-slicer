...
import Div1 from '../components/hocs/Div1'
...
export default function Home() {
  ...
  return (
    <div className='relative'>
      ...
      <Div1>  <img src='./yogagirl.svg'></img></Div1>
     ...
     <Div1>
      ...
      <section className='max-sm:px-0 h-[100vh] flex items-center justify-center'>
        <Div1><h3 className='headingfont font-bold text-3xl max-sm:text-center'>“You didn’t come this far, only to come this far”</h3></Div1>
      </section>
      ...
      <section className='max-sm:px-0 flex flex-col justify-center items-center'>
       ...
       <Div1>
          ...
          <div className='flex gap-6 pt-10 border-t border-black border-b max-sm:flex-col max-sm:gap-0'>
              <div className='flex-1'>
